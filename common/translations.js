const translations = {
  ...
  'en*Relaterede nøgleord': 'Related keywords',
  'en*Fritekst': 'Free text',
  'en*Samling': 'Collection',
  'en*Aktive filtre': 'Active filters',
  'en*Fjern filteret {filter}': 'Remove the {filter} filter',
  'en*{count} resultat fundet': '{count} result found',
  'en*{count} resultater fundet': '{count} results found',
  'en*Kalliope indeholder': 'Kalliope contains',
  'en*{count} dansk digt': '{count} Danish poem',
  'en*{count} danske digte': '{count} Danish poems',
  'en*med nøgleordet': 'with the keyword',
  'en*Museer': 'Museums',
  ...
  'de*Relaterede nøgleord': 'Verwandte Schlagwörter',
  'de*Fritekst': 'Freitext',
  'de*Samling': 'Sammlung',
  'de*Aktive filtre': 'Aktive Filter',
  'de*Fjern filteret {filter}': 'Filter {filter} entfernen',
  'de*{count} resultat fundet': '{count} Ergebnis gefunden',
  'de*{count} resultater fundet': '{count} Ergebnisse gefunden',
  'de*Kalliope indeholder': 'Kalliope enthält',
  'de*{count} dansk digt': '{count} dänisches Gedicht',
  'de*{count} danske digte': '{count} dänische Gedichte',
  'de*med nøgleordet': 'mit dem Schlagwort',
  'de*Museer': 'Museen',
  ...
  'fr*Relaterede nøgleord': 'Mots-clés associés',
  'fr*Fritekst': 'Texte libre',
  'fr*Samling': 'Collection',
  'fr*Aktive filtre': 'Filtres actifs',
  'fr*Fjern filteret {filter}': 'Supprimer le filtre {filter}',
  'fr*{count} resultat fundet': '{count} résultat trouvé',
  'fr*{count} resultater fundet': '{count} résultats trouvés',
  'fr*Kalliope indeholder': 'Kalliope contient',
  'fr*{count} dansk digt': '{count} poème danois',
  'fr*{count} danske digte': '{count} poèmes danois',
  'fr*med nøgleordet': 'avec le mot-clé',
  'fr*Museer': 'Musées',

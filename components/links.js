...
export const poetsURL = (lang = 'da', groupBy = 'name', country = 'dk') => {
...
export const worksURL = (lang = 'da', poetIdId) => {
  return `/${lang}/works/${poetId}`;
};

export const bioURL = (lang = 'da', poetIdId) => {
  return `/${lang}/bio/${poetId}`;
};

export const bibliographyURL = (lang = 'da', poetIdId) => {
  return `/${lang}/bibliography/${poetId}`;
};

export const mentionsURL = (lang = 'da', poetIdId) => {
